...
export const desktopMessages: DesktopMessages = {
  ...
  exportDialogs: {
    ...
    recoveryFiles: {
      title: 'Export raw workspace recovery files',
      button: 'Export recovery archive',
      filter: 'TAR recovery archive',
      overwriteRejected:
        'Choose a new destination; recovery archives never overwrite existing files'
    },
    diagnostics: {
  ...
  agentHibernation: {
    ...
    confirm: 'Hibernate session',
    message: 'Preserve this agent session for resume and stop its current process?',
    detail:
      'A verified Codex checkpoint is available. The conversation can be resumed in a new terminal process.'
  },
  agentTermination: {
    title: 'Stop agent session without a checkpoint?',
    cancel: 'Leave running',
    confirm: 'Stop without checkpoint',
    message: 'No verified checkpoint is available. Stop this exact agent process anyway?',
    detail: 'This will not hibernate the session. Unverified work may be lost.'
  },
  updater: {
